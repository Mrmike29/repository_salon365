                                            ...
                                            <div class="row mb-30">
                                                ...
                                                <div class="form-group col-lg-6">
                                                    <div class="no-gutters input-right-icon">
                                                        <div class="col">
                                                            <div class="input-effect sm2_mb_20 md_mb_20">
                                                                <input class="primary-input date form-control valid-request" type="text" name="date_start" id="date_start" value="{{date('Y-m-d')}}" readonly="true" required>
                                                ...
                                                <div class="form-group col-lg-6">
                                                    <div class="no-gutters input-right-icon">
                                                        <div class="col">
                                                            <div class="input-effect sm2_mb_20 md_mb_20">
                                                                <input class="primary-input date form-control valid-request" type="text" name="date_end" id="date_end" value="{{date('Y-m-d')}}" readonly="true" required>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="input-effect sm2_mb_20 md_mb_20">
                                                    <select class="niceSelect w-100 bb form-control valid-request" name="type_question[]" id="type_question" required>
                                                        ...
                                                        @foreach($tipo_pregunta as $key => $val)
                                                            <option value="{{$val->id}}">{{$val->name}}</option>
                                                        @endforeach
                                                    </select>
                                                    <span class="focus-border"></span>
