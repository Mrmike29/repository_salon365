...
<head>
    ...
    <link rel="stylesheet" href="{{asset('css/bulletin/index.css')}}">
</head>
<body class="admin">
                        ...
                        <div class="white-box" id="container_students" style="border-radius: 0">
                            <div class="dataTables_wrapper no-footer">
                                <table id="table_students" class="table school-table" style="border-radius: 10px; box-shadow: 0 10px 15px rgba(181, 181, 181, 0.8);">
                                    <thead>
                                    <tr>
                                        <th class="left-aligned">Curso</th>
                                        <th class="center-aligned">Estudiante</th>
                                ...
                                <div class="dataTables_paginate paging_simple_numbers" id="table_students_paginate">
                                    ...
                                    <span id="pagination_number"></span>
...
<script type="text/javascript" src="{{asset('js/bulletin/list-bulletin-index.js')}}"></script>
</body>
</html>
