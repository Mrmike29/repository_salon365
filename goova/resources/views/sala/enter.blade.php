		  	...
		  	@foreach($listado as $key=> $value)
			  	<span class="list-group-item " id="list-search" data-name="{{$value->name}} {{$value->last_name}}">
				  	...
				  	<div class="custom-control custom-checkbox">
					    <input type="checkbox" class="custom-control-input" id="defaultUnchecked_{{$key}}" value="{{encrypt($value->id."_str4t3cs4")}}" data-room="{{encrypt($room->id."_str4t3cs4")}}" @if(!empty($value->id_users)) checked @endif>
