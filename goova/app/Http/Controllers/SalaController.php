...

{
...

    {
        ...
        if ($tipo=="Estudiante") {
            ...
            $asignatura=DB::table('teacher_course')
    ...
    public function ingresarSala($id){
        ...
        ->Join('class_assist as cs','cs.id_users','users.id')
    ...
    public function getListado(){
        ...
        $html=view('sala.listado',compact('listado'))->render();
        return $html;
    }
