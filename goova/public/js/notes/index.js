...
const
    ...
    openModalNotes = (id) => {
        ...
        $.ajax({
            ...
            filterNotes(searchN.val(), teacher.val(), subject.val(), previousN, nextN)
        }).fail(() => {
            $("body").overhang({
                type: "error",
    ...
    filterNotes = (search, teacher, subject, previous, next) => {
        ...
        console.log(search, teacher, subject, previous, next)

        $.ajax({
            type: 'GET',
            url: '/get-notes-list',
            data: { search, teacher, subject, prev, nxt },
            success: (data) => {
                let html = '',
                    notes = data.notes,
                    notesC = data.counter,
