                                    ...
                                    '<div class="col-lg-6" id="">' +
                                        '<div class="no-gutters input-right-icon">' +
                                            '<div class="col">' +
                                                '<div class="input-effect date">' +
                                                    '<div class="input-group">' +
                                                        '<input class="read-only-input primary-input date form-control" id="date_create_event" type="text" readonly="true" autocomplete="off" name="date_create_event" value="<?php echo e(date("Y-m-d")); ?>">' +
                                    ...
                                    '<div class="col-lg-6" id="">' +
                                        '<div class="no-gutters input-right-icon">' +
                                            '<div class="col">' +
                                                '<div class="input-effect date">' +
                                                    '<div class="input-group">' +
                                                        '<input class="read-only-input primary-input date form-control" id="date_end_create_event" type="text" readonly="true" autocomplete="off" name="date_end_create_event" value="<?php echo e(date("Y-m-d")); ?>">' +
...
<?php /**PATH C:\Users\Desarrollo1\Desktop\Goova\repository_salon365\goova\resources\views/fechas_importantes.blade.php ENDPATH**/ ?>